...
source: "https://jcoding09.github.io/cloud/certified-solutions-architect-associate/"
author:
  - "[[cloud]]"
published:
created: 2025-02-11
...
tags:
  - "clippings"
---
## [cloud](https://jcoding09.github.io/cloud/)
...
1. [Introduction](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#introduction)
2. [Identity Access Management (IAM)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#identity-access-management-iam)
3. [Simple Storage Service (S3)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#simple-storage-service-s3)
4. [CloudFront](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#cloudfront)
5. [Snowball](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#snowball)
6. [Storage Gateway](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#storage-gateway)
7. [Elastic Compute Cloud (EC2)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#elastic-compute-cloud-ec2)
8. [Elastic Block Store (EBS)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#elastic-block-store-ebs)
9. [Elastic Network Interfaces (ENI)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#elastic-network-interfaces-eni)
10. [Security Groups](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#security-groups)
11. [Web Application Firewall (WAF)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#web-application-firewall-waf)
12. [CloudWatch](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#cloudwatch)
13. [CloudTrail](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#cloudtrail)
14. [Elastic File System (EFS)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#elastic-file-system-efs)
15. [Amazon FSx for Windows](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#amazon-fsx-for-windows)
16. [Amazon FSx for Lustre](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#amazon-fsx-for-lustre)
17. [Relational Database Service (RDS)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#relational-database-service-rds)
18. [Aurora](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#aurora)
19. [DynamoDB](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#dynamodb)
20. [Redshift](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#redshift)
21. [ElastiCache](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#elasticache)
22. [Route53](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#route53)
23. [Elastic Load Balancers (ELB)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#elastic-load-balancers-elb)
24. [Auto Scaling](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#auto-scaling)
25. [Virtual Private Cloud (VPC)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#virtual-private-cloud-vpc)
26. [Simple Queuing Service (SQS)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#simple-queuing-service-sqs)
27. [Simple Workflow Service (SWF)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#simple-workflow-service-swf)
28. [Simple Notification Service (SNS)](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#simple-notification-service-sns)
29. [Kinesis](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#kinesis)
30. [Lambda](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#lambda)
31. [API Gateway](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#api-gateway)
32. [CloudFormation](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#cloudformation)
33. [ElasticBeanstalk](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#cloudformation)
34. [AWS Organizations](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#aws-organizations)
35. [Miscellaneous](https://jcoding09.github.io/cloud/certified-solutions-architect-associate/#miscellaneous)
...
- The data consistency model for S3 also ensures immediate read access for PUTS and DELETES of already existing objects, [since Decembre 2020](https://aws.amazon.com/fr/about-aws/whats-new/2020/12/amazon-s3-now-delivers-strong-read-after-write-consistency-automatically-for-all-applications/).
...
![storage_types](https://user-images.githubusercontent.com/13093517/83919060-e1247180-a747-11ea-9336-e92ee163ac7a.png)
...
The AWS CDN service is called CloudFront. It serves up cached content and assets for the increased global performance of your application. The main components of CloudFront are the edge locations (cache endpoints), the origin (original source of truth to be cached such as an EC2 instance, an S3 bucket, an Elastic Load Balancer or a Route 53 config), and the distribution (the arrangement of edge locations from the origin or basically the network itself). [More info on CloudFront’s features](https://aws.amazon.com/cloudfront/features/)
...
- A further comparison between MemcacheD and Redis for ElastiCache: ![Screen Shot 2020-06-18 at 8 18 34 PM](https://user-images.githubusercontent.com/13093517/85083820-edc1b480-b1a0-11ea-88b0-15f90bd60282.png)
...
| NACL | Security Group | | ————- | ————- | | Operates at the subnet level | Operates at the instance level | | Supports allow rules and deny rules | Supports allow rules only | | Is stateless: Return traffic must be explicitly allowed by rules | Is stateful: Return traffic is automatically allowed, regardless of any rules | | We process rules in order, starting with the lowest numbered rule, when deciding whether to allow traffic | We evaluate all rules before deciding whether to allow traffic | | Automatically applies to all instances in the subnets that it’s associated with (therefore, it provides an additional layer of defense if the security group rules are too permissive) | Applies to an instance only if someone specifies the security group when launching the instance, or associates the security group with the instance later on |
